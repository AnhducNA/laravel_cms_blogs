            ...
            <div class="d-flex justify-content-between flex-column flex-md-row">
                <div class="main-news box col-12 col-md-main-news ">
                    <div class="box-top">
                        <a href="detail.html" class="w-100 h-100">
                            <img class="img-main-news" src="{{asset('assets/images/news/main-news.png')}}"
                                 alt="main-news.png">
                        </a>
                    ...
                    <div class="box-content">
                        <p class="p-title"><a href="">Making a Housing Wage: Where Teachers, First Responders and
                                Restaurant
                                Workers Can Live Where They Work</a></p>
                        <ul>
                ...
                <div class="sub-news row box col-12 col-md-sub-news flex-column flex-sm-row">
                    <div class="sub-news-item col-sm-6 col-md-12">
                        ...
                        <div class="box-content">
                            <p class="p-title"><a href="">Making a Housing Wage: Where Restaurant Workers Can They
                                    Work</a></p>
                            <ul>
                                <li><a href="#"><p>Xã hội</p></a></li>
                                <li><span class="dot"><svg width="3" height="4" viewBox="0 0 3 4" fill="none"
                    ...
                    <div class="sub-news-item col-sm-6 col-md-12">
                        ...
                        <div class="box-content">
                            <p class="p-title">Making a Housing Wage: Where Restaurant Workers Can They Work</p>
                            <ul>
                                <li><a href="#"><p>Xã hội</p></a></li>
                                <li><span class="dot"><svg width="3" height="4" viewBox="0 0 3 4" fill="none"
                                                           xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="main-video col-sm-12 col-md-main-video box">
                    <div class="box-top h-100">
                        <a href="" class="d-block w-100 h-100">
                            <img class="h-100" src="{{asset('assets/images/videos/main-video.png')}}"
                                 alt="main-video.png">
                        </a>
                    ...
                    <div class="sub-video-item col-md-12">
                        <div class="box-top">
                            <a href="" class="w-100 h-100">
                                <img class="img-main-news" src="{{asset('assets/images/videos/sub-video1.png')}}"
                                     alt="main-news.png">
                            </a>
                            <span class="pause-video">
                              <img src="{{asset('assets/images/stop-video.png')}}" alt="stop-video.png">

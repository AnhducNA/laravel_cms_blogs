    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center justify-between mt-6">
                <div class="flex ">
                    <x-forms.label for="loginCheck" value="{{ __('Remember me?') }}" class="mr-2"/>
                    <x-forms.input type="checkbox" name="remember" id="loginCheck" style="width: auto"/>
                </div>
